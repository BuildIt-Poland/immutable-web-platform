...
let
  ...
  # version with space ... good job ... https://github.com/brigadecore/brigade/blob/master/brigade-worker/package.json#L3
  # need to provide a PR for it as it is super silly
  ...
  brigade-worker-base = pkgs.yarn2nix.mkYarnPackage {
    name = "brigade-worker";
    src = fixed-source;
